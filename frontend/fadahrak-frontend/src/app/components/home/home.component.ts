    ...
    <div class="min-h-screen">
          ...
          <div class="flex flex-col md:flex-row justify-center gap-6 px-4">
            <ng-container *ngIf="isLoggedIn; else guestButtons">
              <a [routerLink]="user?.role === 'shop_owner' ? '/owner-dashboard' : '/seeker-dashboard'"
                 class="btn-primary text-lg md:text-xl px-8 md:px-12 py-4 md:py-5 rounded-full flex items-center justify-center gap-3">
                <i class="fas fa-tachometer-alt icon"></i>
                لوحة التحكم
              </a>
              <a routerLink="/jobs" class="btn-secondary text-lg md:text-xl px-8 md:px-12 py-4 md:py-5 rounded-full flex items-center justify-center gap-3">
            ...
            <ng-template #guestButtons>
              <a routerLink="/jobs" class="btn-primary text-lg md:text-xl px-8 md:px-12 py-4 md:py-5 rounded-full flex items-center justify-center gap-3">
                <i class="fas fa-search icon"></i>
                ابحث عن وظائف
              </a>
              <a routerLink="/signup" class="btn-secondary text-lg md:text-xl px-8 md:px-12 py-4 md:py-5 rounded-full flex items-center justify-center gap-3">
        ...
        <div class="max-w-6xl mx-auto px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div class="card p-8 md:p-12 text-center">
              <i class="fas fa-user-plus icon-lg text-primary"></i>
            ...
            <div class="card p-8 md:p-12 text-center">
              <i class="fas fa-briefcase icon-lg text-primary"></i>
            ...
            <div class="card p-8 md:p-12 text-center">
              <i class="fas fa-comments icon-lg text-primary"></i>
      ...
      <section class="bg-gray-100 py-16 md:py-24">
        <div class="max-w-4xl mx-auto text-center px-6">
          ...
          <a routerLink="/success-stories" class="btn-primary text-lg md:text-xl px-10 md:px-12 py-4 md:py-5 rounded-full inline-flex items-center gap-3">
