  ...
  template: `
    <div class="min-h-screen py-20 px-6 bg-gradient-to-br from-gray-50 to-indigo-50">
      <div class="max-w-2xl mx-auto">
        <div class="card p-10">
          <h1 class="text-4xl font-bold text-center mb-8 flex justify-center items-center"><i class="fas fa-user-plus icon text-primary mr-2"></i>إنشاء حساب جديد</h1>
          <form (ngSubmit)="onSubmit()" class="grid md:grid-cols-2 gap-6">
            <div class="relative">
            ...
            <div class="relative">
              ...
              <input [(ngModel)]="form.name" name="name" placeholder="الاسم الكامل" class="input-field pr-12" required>
            </div>
            <div class="relative">
              <i class="fas fa-birthday-cake absolute right-4 top-4 text-gray-500"></i>
              <input [(ngModel)]="form.age" name="age" type="number" placeholder="العمر" class="input-field pr-12" required>
            </div>
            <div class="relative">
            ...
            <div class="md:col-span-2">
              <label class="block text-gray-700 mb-2 flex items-center"><i class="fas fa-user-tag icon mr-2"></i>نوع الحساب</label>
              <div class="flex gap-6">
                <label class="flex items-center cursor-pointer">
                  <input type="radio" [(ngModel)]="form.role" name="role" value="job_seeker" class="form-radio text-primary">
                  <span class="mr-2">باحث عن عمل</span>
                </label>
                <label class="flex items-center cursor-pointer">
                  <input type="radio" [(ngModel)]="form.role" name="role" value="shop_owner" class="form-radio text-primary">
            ...
            <div *ngIf="form.role === 'job_seeker'" class="md:col-span-2 animate-fade-in">
              <div class="relative">
                ...
                <input [(ngModel)]="form.work_experience" name="work_experience" placeholder="الخبرة المهنية" class="input-field pr-12">
              </div>
              <div class="relative mt-4">
                <i class="fas fa-tags absolute right-4 top-4 text-gray-500"></i>
                <input [(ngModel)]="form.desired_job_type" name="desired_job_type" placeholder="نوع الوظيفة المرغوبة" class="input-field pr-12">
              </div>
            </div>
            ...
            <div *ngIf="form.role === 'shop_owner'" class="md:col-span-2 animate-fade-in">
              <div class="relative">
                ...
                <input [(ngModel)]="form.shop_name" name="shop_name" placeholder="اسم المحل" class="input-field pr-12">
              </div>
            </div>
          ...
          <p *ngIf="error" class="text-danger text-center mt-4 flex items-center justify-center md:col-span-2"><i class="fas fa-exclamation-triangle icon mr-2"></i>{{ error }}</p>
          <p class="text-center mt-6 text-gray-600 md:col-span-2">
